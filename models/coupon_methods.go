...
func (cd *CartWiseDetails) IsAppicable(cart *Cart) (bool, float32) {
...
func (pd *ProductWiseDetails) IsAppicable(cart *Cart) (bool, float32) {
...
func (bx *BxGyDetails) ApplyCoupon(cart *Cart) float32 {
	return 0
}
